$(document).ready(function(){
    ...
    $(".open-delete-standhouder-popup").on("click", function(){
        $('#standhouder_id').val($(this).closest('tr').attr('data-id'));
        $(".popup-delete-standhouder").show();
        $(".overlay").show();
    });

    $(".cancel-delete-standhouder").on("click", function(){
        $(".popup-delete-standhouder").hide();
        $(".overlay").hide();
    });

    $('.delete-standhouder').on('click', function(){
        $.post
    });
