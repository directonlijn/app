        ...
        */
        ...
        else
        {
            if ($standhouderExtra->kraam > 0)
            {
                ...
                $pdf_data['tabel'][$key]['prijsperstuk'] = "€".number_format(round($markt->bedrag_kraam/1.21*$aantal_dagen, 2), 2);
            ...
            if ($standhouderExtra->grondplek > 0)
            {
                ...
                $pdf_data['tabel'][$key]['btw'] = "21%";
                $pdf_data['tabel'][$key]['prijsperstuk'] = "€".number_format(round($markt->bedrag_grondplek/1.21*$aantal_dagen, 2), 2);
                $pdf_data['tabel'][$key]['totaal'] = "€ " . number_format(round($markt->bedrag_kraam*($standhouderExtra->grondplek/1.21)*$aantal_dagen, 2), 2);
            }
