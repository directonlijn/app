...
$name = 'Hippiemarkt Beachfestival Zeewolde';
$markt_id = 17;
?>
<html>
<head>
    ...
    <base href="http://{{ $_SERVER['HTTP_HOST'] }}/beachfestival-zeewolde/">
    ...
    <link rel="image_src" href="http://app.directevents.nl/assets/img/beachfestival-zeewolde/hippiemarkt-beachfestival-zeewolde.jpg">
</head>
<body>
<div class="container">
    <div class="row">
