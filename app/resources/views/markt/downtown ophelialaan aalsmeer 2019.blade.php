...
$name = 'Downtown Ophelialaan Aalsmeer 2019';
$markt_id = 18;
?>
<html>
<head>
    ...
    <base href="http://{{ $_SERVER['HTTP_HOST'] }}/downtown ophelialaan aalsmeer 2019/">
    ...
    <link rel="image_src" href="http://app.directevents.nl/downtown ophelialaan aalsmeer 2019/mail.jpg">
</head>
<body>
<div class="container">
    <div class="row">
