<?php
    ...
    $name = 'Ibizamarkt Aquabest Eindhoven';
    $markt_id = 16;
?>
<html>
    <head>
        ...
        <base href="http://{{ $_SERVER['HTTP_HOST'] }}/ibizamarkteindhoven/">
        ...
        <meta property="og:url"                content="http://www.ibizamarkteindhoven.nl" />
                        ...
                        <div class="container">
                            ...
                            <section data-section="marktgegevens">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="kramen">Aantal kramen (&euro;120,- excl. BTW): *</label>
