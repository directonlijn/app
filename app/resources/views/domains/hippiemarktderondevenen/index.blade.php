...
<html>
    <head>
        ...
        <base href="http://{{ $_SERVER['HTTP_HOST'] }}/hippiemarktderondevenen/">
        ...
        <meta property="og:url"                content="http://www.hippiemarktderondevenen.nl" />
        <meta property="og:type"               content="website" />
        <meta property="og:title"              content="Hippiemarkt De Ronde Venen - Direct Events" />
        <meta property="og:description"        content="Hippiemarkt De Ronde Venen is op zondag 24 juni van 12:00 tot 18:00 op Eiland 1 te Vinkeveen" />
        <meta property="og:image"              content="http://app.directevents.nl/assets/img/hippiemarkt-de-ronde-venen/mail-header.png" />

        <link rel="image_src" href="http://app.directevents.nl/assets/img/hippiemarkt-de-ronde-venen/mail-header.png">
    </head>
    <body>
        <div class="container">
            <div class="row">
    			...
    			<div class="form-style-10">
    				...
    				<form class="test-form" action="test.php" method="post">
    				    ...
    				    <div class="inner-wrap">
    				        ...
    				        <label>Aantal grondplekken (per meter, &euro;27,50 incl. BTW per dag): <input type="number" name="grondplekken" value="0"/></label>
