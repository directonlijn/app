...
$name = 'Pepernotenmarkt Amsterdam Osdorp';
$markt_id = 13;
?>
...
<html>
    <head>
        ...
        <base href="http://{{ $_SERVER['HTTP_HOST'] }}/pepernotenmarktamsterdam/">

        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.2/dist/jquery.fancybox.min.css" />
        <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,700" rel="stylesheet">

        <link media="all" type="text/css" rel="stylesheet" href="style/main.css">

        <meta property="og:url"                content="http://www.pepernotenmarktamsterdam.nl" />
        ...
        <div class="container">
            <div class="row">
                <div class="d-none d-md-block col-md-4">
                    <div class="round round-date">
                        2 DEC
                    </div>
                    <div class="round round-time">
                        11:00
                        <span>-</span>
                        17:00
                    </div>
