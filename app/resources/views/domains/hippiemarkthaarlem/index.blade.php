...
<head>
    ...
    <meta property="og:image" content="<?=$markt->Website;?>/<?=$name_lowered_without_spaces;?>/mail.jpg">
    ...
    <base href="http://{{ $_SERVER['HTTP_HOST'] }}/<?=$name_lowered_without_spaces;?>/">
    ...
    <link rel="image_src" href="<?=$markt->Website;?>/<?=$name_lowered_without_spaces;?>/mail.jpg">
</head>
<body>
<div class="container">
    <div class="row">
                ...
                <div class="container">
                    ...
                    <section data-section="marktgegevens">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="kramen">Aantal kramen (€<?=$kraam_prijs;?> excl. BTW): *</label>
                                    <input type="text" class="form-control" id="kramen" name="kramen"
                                           placeholder="Aantal kramen">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="grondplek">Grondplek per strekkende meter (&euro;<?=$grondplek_prijs;?>
                                        excl. BTW): *</label>
                                    <input type="text" class="form-control" id="grondplek" name="grondplekken"
                                           placeholder="Aantal meters">
                                </div>
                            </div>
                        </div>
                        <div class="row checkboxes mt-3">
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[0]" id="grote-maten"
                                           value="grote-maten">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[1]" id="dames-kleding"
                                           value="dames-kleding">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[2]" id="heren-kleding"
                                           value="heren-kleding">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[3]" id="kinder-kleding"
                                           value="kinder-kleding">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    <label for="baby-kleding">Babykleding:</label>
                                    <input type="checkbox" class="form-control" name="producten[4]" id="baby-kleding"
                                           value="baby-kleding">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[5]"
                                           id="fashion-accesoires" value="fashion-accesoires">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    <label for="schoenen">Schoenen:</label>
                                    <input type="checkbox" class="form-control" name="producten[6]" id="schoenen"
                                           value="schoenen">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[7]" id="lifestyle"
                                           value="lifestyle">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[8]"
                                           id="woon-accessoires" value="woon-accessoires">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    <label for="kunst">Kunst:</label>
                                    <input type="checkbox" class="form-control" name="producten[9]" id="kunst"
                                           value="kunst">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[10]" id="sieraden"
                                           value="sieraden">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[11]" id="tassen"
                                           value="tassen">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[12]" id="brocante"
                                           value="brocante">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[13]" id="dierenspullen"
                                           value="dierenspullen">
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-control" name="producten[14]" id="anders"
                                           value="anders">
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        $("._aanmeldformulieropenen").fancybox({
            'onStart': function () {
                $("#aanmelden").removeClass('hidden');
            },
            'onClosed': function () {
                $("#aanmelden").addClass('hidden');
            }
        });
